...
write.csv(output_neg3,file = "D:/Users/czx/PycharmProjects/HNGDTI/Drugbank dataset/negative samples/neg-bias3_5_7_9/neg3_8020.csv",row.names =FALSE,quote = F)
write.csv(output_neg5,file = "D:/Users/czx/PycharmProjects/HNGDTI/Drugbank dataset/negative samples/neg-bias3_5_7_9/neg5_8020.csv",row.names =FALSE,quote = F)
write.csv(output_neg7,file = "D:/Users/czx/PycharmProjects/HNGDTI/Drugbank dataset/negative samples/neg-bias3_5_7_9/neg7_8020.csv",row.names =FALSE,quote = F)
write.csv(output_neg9,file = "D:/Users/czx/PycharmProjects/HNGDTI/Drugbank dataset/negative samples/neg-bias3_5_7_9/neg9_8020.csv",row.names =FALSE,quote = F)
