library(dplyr)
all_DTI = read.csv("D:/Users/czx/PycharmProjects/HNGDTI/Drugbank dataset/DTI_8207.csv",header=T)
...
# all_network
shortset_length = read.csv("D:/Users/czx/PycharmProjects/HNGDTI/Drugbank dataset/Dr_D_P_shortest_length.csv",header=T)
...
N5 = read.csv("D:/Users/czx/PycharmProjects/HNGDTI/Drugbank dataset/negative samples/DTI benchmark N3_5_7_9/N5.csv",header=T)
...
# both l_h>=3 & l_b=3
write.csv(my_need_neg_lb3,file = "D:/Users/czx/PycharmProjects/HNGDTI/Drugbank dataset/negative samples/my_need_neg3.csv",row.names =FALSE,quote = F)
# both l_h>=3 & l_b=5
write.csv(my_need_neg_lb5,file = "D:/Users/czx/PycharmProjects/HNGDTI/Drugbank dataset/negative samples/my_need_neg5.csv",row.names =FALSE,quote = F)


# DTI-extra set
extra_DTI = read.csv("D:/Users/czx/PycharmProjects/HNGDTI/Drugbank dataset/DTI-extra_set/DTI_187.csv",header=T)
extra_Drug = read.csv("D:/Users/czx/PycharmProjects/HNGDTI/Drugbank dataset/DTI-extra_set/Drug_111.csv",header=T)
extra_Protein = read.csv("D:/Users/czx/PycharmProjects/HNGDTI/Drugbank dataset/DTI-extra_set/Protein_123.csv",header=T)
...
x = unique(neg1[,1])
y = unique(neg1[,2])
write.csv(neg2,file = "D:/Users/czx/PycharmProjects/HNGDTI/Drugbank dataset/negative samples/extra_neg3.csv",row.names =FALSE,quote = F)
