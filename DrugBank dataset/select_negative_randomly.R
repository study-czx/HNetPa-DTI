...
dr_id = read.csv("D:/Users/czx/PycharmProjects/HNGDTI/Drugbank dataset/DTI-benchmark_set/Drug_1409.csv",header=T)
p_id = read.csv("D:/Users/czx/PycharmProjects/HNGDTI/Drugbank dataset/DTI-benchmark_set/Protein_1648.csv",header=T)
postive = read.csv("D:/Users/czx/PycharmProjects/HNGDTI/Drugbank dataset/DTI-benchmark_set/DTI_8020.csv",header=T)
...
x = unique(n_all[,1])
y = unique(n_all[,2])
write.csv(n_all,file="D:/Users/czx/PycharmProjects/HNGDTI/Drugbank dataset/negative samples/neg_DTI-rand_8020.csv",row.names =FALSE,quote = F)
...
write.csv(n_1_2_news,file="D:/Users/czx/PycharmProjects/HNGDTI/Drugbank dataset/negative samples/neg_DTI-rand_187.csv",row.names =FALSE,quote = F)
