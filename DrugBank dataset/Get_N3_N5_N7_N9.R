Only_Dr_P_shortest_length = read.csv("D:/Users/czx/PycharmProjects/HNetPa-DTI/Drugbank dataset/Dr_P_shortest_length.csv",header=T)
...
write.csv(neg3,file = "D:/Users/czx/PycharmProjects/HNetPa-DTI/Drugbank dataset/negative samples/DTI benchmark N3_5_7_9/N3.csv",row.names =FALSE,quote = F)
write.csv(neg5,file = "D:/Users/czx/PycharmProjects/HNetPa-DTI/Drugbank dataset/negative samples/DTI benchmark N3_5_7_9/N5.csv",row.names =FALSE,quote = F)
write.csv(neg7,file = "D:/Users/czx/PycharmProjects/HNetPa-DTI/Drugbank dataset/negative samples/DTI benchmark N3_5_7_9/N7.csv",row.names =FALSE,quote = F)
write.csv(neg9,file = "D:/Users/czx/PycharmProjects/HNetPa-DTI/Drugbank dataset/negative samples/DTI benchmark N3_5_7_9/N9.csv",row.names =FALSE,quote = F)
