    ...
    def __init__(self):
        ...
        self.Graph_Net = HGCN(
            {'d-t-dr': SAGE(in_feats=(n_hidden, n_hidden), out_feats=n_hidden,  feat_drop=drop_feat, aggregator_type=agg, activation=F.relu),
             ...
             'dr-p': SAGE(in_feats=(n_hidden, n_hidden), out_feats=n_hidden, feat_drop=drop_feat, aggregator_type=agg,
                         activation=F.relu),
             'p-dr': SAGE(in_feats=(n_hidden, n_hidden), out_feats=n_hidden, feat_drop=drop_feat, aggregator_type=agg,
                         activation=F.relu)},
            aggregate='sum')
...
for data_type in data_types:
    for type in types:
        ...
        pd_output.to_csv(data_type + type + '_scores_with_DTI_in_G.csv')
