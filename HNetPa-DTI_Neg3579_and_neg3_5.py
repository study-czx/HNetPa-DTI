...
n_hidden = 128
th = 0.005
# neg 3,5,7,9 and neg-bias 3,5,7,9
    ...
    for type in types:
        for i in range(5):
            ...
            for epoch in range(num_epoches):
                ...
                #         .format(epoch, train_avloss, train_acc, train_auc, dev_aupr, test_acc, test_auc, test_aupr))
        ...
        pd_output.to_csv(data_type + type + '_scores.csv')
