...
class My_Net(nn.Module):
    ...
    def forward(self, x_dr, x_p, finger_feats, seq_feats, disease_feat, MF_feat, BP_feat, CC_feat,
        ...
        # concat features
        dr_new = h_dr_finger
        p_new = torch.cat((h_p_seq, h_p_GO+h_p_pathway), dim=1)
...
for data_type in data_types:
    for type in types:
            ...
            for epoch in range(num_epoches):
                ...
                for step, (batch_x, batch_y) in enumerate(train_loader):
                    ...
                    output = model(b_x_dr, b_x_p, finger_feats, seq_feats, disease_feats,
                                   MF_feat, BP_feat, CC_feat, pathway_feat, GO2P_G, Path2P_G)
        ...
        pd_output.to_csv(data_type + type + '_scores_without_heterogeneous.csv')
