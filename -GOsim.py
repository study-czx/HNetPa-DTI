...
class My_Net(nn.Module):
    ...
    # 前向传播
    def forward(self, x_dr, x_p, finger_feats, seq_feats, disease_feat, MF_feat, BP_feat, CC_feat, Pathway_feat, GO2P_G, my_G, Path2P_G):
        ...
        mf_feat, bp_feat, cc_feat = h_mf, h_bp, h_cc
...
for data_type in data_types:
    for type in types:
        ...
        pd_output.to_csv(data_type + type + '_scores_without_GOsim.csv')
