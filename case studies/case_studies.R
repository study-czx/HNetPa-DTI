...
predict_scoress = predict_scoress[sample(nrow(predict_scoress)), ]
# view scores
...
# get top 10 scores
top10_score = my_predict_score[1:10,]
write.csv(top10_score,"D:/Users/czx/PycharmProjects/HNetPa-DTI/case studies/top10_scores.csv",,row.names = F)
