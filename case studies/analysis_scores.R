Drug_1408 = read.csv("D:/Users/czx/PycharmProjects/HNGO-DTI/DrugBank dataset/DTI-benchmark_set/Drug_1409.csv",header= T)
Protein_1648 = read.csv("D:/Users/czx/PycharmProjects/HNGO-DTI/DrugBank dataset/DTI-benchmark_set/Protein_1648.csv",header= T)
...
# Predict scores
Predict_scores = read.csv("D:/Users/czx/PycharmProjects/HNGO-DTI/Predict_scores.csv",header= T)
